...
Η εφαρμογή είναι deployed στο Railway και τρέχει με Gunicorn μέσω του `start.sh`.
...
- Εγγραφή χρήστη (username, email, όνομα, επώνυμο)
- Σύνδεση με JWT authentication (access & refresh tokens)
...
- Παραγωγή time slots ανά υπηρεσία και ημέρα (π.χ. 09:00–17:00 ανά 30’)
...
### Υπάρχουν αρχικά δεδομένα στο project:

`python manage.py loaddata fixtures/seed.json`

**Σε Windows, το αρχείο πρέπει να είναι UTF-8 χωρίς BOM.**

---

## 🛠️ Σημειώσεις για Railway
- Η παραγωγική εκκίνηση γίνεται μέσω start.sh
- Το seeding εκτελείται μόνο μία φορά σε νέα βάση
- Μετά επαναφέρεται το κανονικό start command
